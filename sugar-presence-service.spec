...
Source: http://download.sugarlabs.org/sources/sucrose/glucose/sugar-presence-service/sugar-presence-service-0.83.2.tar.bz2

Requires: telepathy-gabble >= 0.7.16
Requires: sugar-base >= 0.83.2
Requires: avahi  
Requires: python-telepathy >= 0.15.3
Requires: gnutls >= 2.6
Requires: python  
Requires: telepathy-salut >= 0.3.6
...
%prep
%setup -q -n sugar-presence-service-0.83.2
